...
import com.cda.security.service.IJwtTokenRepository;
...
public class JwtAuthenticationTokenFilter extends GenericFilterBean {
	...
	@Autowired
    private IJwtTokenRepository jwtTokenServiceRepository;
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain)
		...
		if (token.isPresent() && token.get().startsWith("Bearer")) {
			...
			try {
				...
				Authentication authentication = jwtTokenServiceRepository.validateJwtToken(bearerToken);				
